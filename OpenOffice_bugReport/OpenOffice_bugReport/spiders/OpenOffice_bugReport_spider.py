...
class BugReportSpider(scrapy.Spider):
    name = "OpenOffice_bugReport"
    
    def start_requests(self):
        url_1 = "https://bz.apache.org/ooo/show_bug.cgi?id="
        url_2 = "https://bz.apache.org/ooo/show_activity.cgi?id="
        
        #yield scrapy.Request(url=url_1+'120382', callback=self.parse)
        #yield scrapy.Request(url=url_2+'120382', callback=self.parse_history)
        
        with open("/home/carrie/scrapyCrawe/mySpider/OpenOffice_nonReopen_urls.csv") as f:
    ...
    def parse_history(self, response):
        ...
        filename = '/home/carrie/scrapyCrawe/OpenOffice_bugReport/nonreopen_OpenOffice_2.txt'
    ...
    def parse(self, response):
        page = response.url.split("?")[-1]
        filename_1 = '/home/carrie/scrapyCrawe/OpenOffice_bugReport/nonreopen_OpenOffice_1.txt'
        with open(filename_1, 'a') as of:
            ...
            of.write('\t')
            #Assignee
            assigned = response.xpath('//*[@id="bz_show_bug_column_1"]/table/tr[13]/td/span/span/text()').extract()
            if len(assigned) == 0:
                of.write('None')
            else:
                for ass in assigned:
