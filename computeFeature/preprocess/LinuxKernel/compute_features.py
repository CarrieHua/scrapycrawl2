    ...
    with open(filename) as f:
        for line in f:
            ...
            if len(mid) == 23:
                ...
                output.write('\t')
                #compute CC
                cc = mid[11].strip().split()[0]
                output.write(cc)
                output.write('\t')
                #compute description size
                description = mid[14].strip()
...
def main():
    ...
    main function
    """
    filename = "/home/carrie/scrapyCrawe/LinuxKernel_bugReport/LinuxKernel.txt"
    features_file = "/home/carrie/scrapyCrawe/computeFeature/LinuxKernel/LinuxKernel__features.txt"
    token_probability_file = "/home/carrie/scrapyCrawe/computeFeature/LinuxKernel/token_probability.txt"
