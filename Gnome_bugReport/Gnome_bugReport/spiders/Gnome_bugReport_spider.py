...
class BugReportSpider(scrapy.Spider):
    name = "Gnome_bugReport"
    
    def start_requests(self):
        url_1 = "https://bugzilla.gnome.org/show_bug.cgi?id="
        url_2 = "https://bugzilla.gnome.org/show_activity.cgi?id="
        
        #yield scrapy.Request(url=url_1+'567269', callback=self.parse)
        #yield scrapy.Request(url=url_2+'567269', callback=self.parse_history)
        
        with open("/home/carrie/scrapyCrawe/mySpider/Gnome_reopen_urls.csv") as f:
    ...
    def parse_history(self, response):
        ...
        filename = '/home/carrie/scrapyCrawe/Gnome_bugReport/reopen_Gnome_2.txt'
        ...
        with open(filename, 'a') as of:
            ...
            change_item = response.xpath('//*[@id="bugzilla-body"]/table/tr/td[last()-2]/text()').extract()
    ...
    def parse(self, response):
        page = response.url.split("?")[-1]
        filename_1 = '/home/carrie/scrapyCrawe/Gnome_bugReport/reopen_Gnome_1.txt'
