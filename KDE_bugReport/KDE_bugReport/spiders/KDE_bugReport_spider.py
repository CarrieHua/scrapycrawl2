...
class BugReportSpider(scrapy.Spider):
    ...
    def start_requests(self):
        url_1 = "https://bugs.kde.org/show_bug.cgi?id="
        url_2 = "https://bugs.kde.org/show_activity.cgi?id="
        
        #yield scrapy.Request(url=url_1+'116482', callback=self.parse)
        #yield scrapy.Request(url=url_2+'116482', callback=self.parse_history)
        
        with open("/home/carrie/scrapyCrawe/mySpider/KDE_reopen_urls.csv") as f:
    ...
    def parse_history(self, response):
        ...
        filename = '/home/carrie/scrapyCrawe/KDE_bugReport/reopen_KDE_2.txt'
    ...
    def parse(self, response):
        page = response.url.split("?")[-1]
        filename_1 = '/home/carrie/scrapyCrawe/KDE_bugReport/reopen_KDE_1.txt'
        with open(filename_1, 'a') as of:
            ...
            of.write('\t')
            #platform
            platform = response.xpath('//*[@id="bz_show_bug_column_1"]/table/tr[9]/td/text()').extract()
            if len(platform) == 0:
                of.write('None')
            else:
